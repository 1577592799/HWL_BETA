...
import com.hwl.beta.databinding.ActivityVideoPlayBinding;
...
public class ActivityVideoPlay extends FragmentActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(activity, R.layout.activity_video_play);
