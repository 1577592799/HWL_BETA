...
public class DirPopupWindow extends PopupWindow implements View.OnClickListener {
    ...
    public DirPopupWindow(Context context, BaseAdapter adapter) {
        super(context);

        final View view = View.inflate(context, R.layout.image_dir_pop, null);
        masker = view.findViewById(R.id.fl_masker);
        masker.setOnClickListener(this);
        marginView = view.findViewById(R.id.v_margin);
        marginView.setOnClickListener(this);
        listView = view.findViewById(R.id.lv_dirs);
        ...
        view.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver
            ...
            public void onGlobalLayout() {
                ...
                LinearLayout.LayoutParams marginParams = (LinearLayout.LayoutParams) marginView
                        .getLayoutParams();
