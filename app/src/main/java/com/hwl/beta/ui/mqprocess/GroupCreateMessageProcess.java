...
public class GroupCreateMessageProcess implements IMessageProcess<GroupCreateMessageBean> {
    ...
    public void execute(byte messageType, GroupCreateMessageBean model) {
        ...
        DaoUtils.getGroupInfoManagerInstance().add(DBGroupAction.convertToGroupInfo(model.getGroupGuid(), model.getGroupName(), model.getGroupUsers().size(), model.getGroupImage(), model.getBuildTime()));
