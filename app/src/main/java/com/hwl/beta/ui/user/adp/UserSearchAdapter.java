...
public class UserSearchAdapter extends BaseAdapter {
    ...
    public UserSearchAdapter(Context context, List<UserSearchInfo> users, IUserSearchItemListener itemListener) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            itemBinding = DataBindingUtil.inflate(inflater, R.layout.user_search_item, parent, false);
