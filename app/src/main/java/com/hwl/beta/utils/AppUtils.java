...
//        HWLApp.getContext().startActivity(IntentUtils.getInstallAppIntent(file, true));
//    }
...
//        if (!isFileExists(file)) return;
//        HWLApp.getContext().startActivity(IntentUtils.getInstallAppIntent(file, authority, true));
//    }
...
//        HWLApp.getContext().startActivity(IntentUtils.getUninstallAppIntent(packageName, true));
//    }
//
//    /**
//     * Uninstall the app.
...
//    }
    ...
    public static boolean isAppInstalled(@NonNull final String action,
        ...
        PackageManager pm = HWLApp.getContext().getPackageManager();
...
//    }
    ...
    public static boolean isAppDebug() {
        return isAppDebug(HWLApp.getContext().getPackageName());
    }
    ...
    public static boolean isAppSystem() {
        return isAppSystem(HWLApp.getContext().getPackageName());
    }
...
//        if (isSpace(packageName)) return;
//        HWLApp.getContext().startActivity(IntentUtils.getLaunchAppIntent(packageName, true));
//    }
//
//    /**
//     * Launch the application.
...
//    }
    ...
    public static void relaunchApp() {
        ...
        HWLApp.getContext().startActivity(mainIntent);
        System.exit(0);
    }
...
//        launchAppDetailsSettings(HWLApp.getContext().getPackageName());
//    }
//
//    /**
//     * Launch the application's details settings.
...
//        if (isSpace(packageName)) return;
//        HWLApp.getContext().startActivity(
...
//    }
    ...
    public static Drawable getAppIcon() {
        return getAppIcon(HWLApp.getContext().getPackageName());
    }
    ...
    public static String getAppPackageName() {
        return HWLApp.getContext().getPackageName();
    }
    ...
    public static String getAppName() {
        return getAppName(HWLApp.getContext().getPackageName());
    }
    ...
    public static String getAppPath() {
        return getAppPath(HWLApp.getContext().getPackageName());
    }
    ...
    public static String getAppVersionName() {
        return getAppVersionName(HWLApp.getContext().getPackageName());
    }
    ...
    public static int getAppVersionCode() {
        return getAppVersionCode(HWLApp.getContext().getPackageName());
    }
    ...
    public static Signature[] getAppSignature() {
        return getAppSignature(HWLApp.getContext().getPackageName());
    }
    ...
    public static String getAppSignatureSHA1() {
        return getAppSignatureSHA1(HWLApp.getContext().getPackageName());
    }
    ...
    public static AppInfo getAppInfo() {
        return getAppInfo(HWLApp.getContext().getPackageName());
    }
