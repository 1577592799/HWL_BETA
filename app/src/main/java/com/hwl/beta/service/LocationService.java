...
public class LocationService {
    ...
    private int currentLocationStatus = LocationService.NOT_START;

    public LocationService(final OnLocationListener onLocationListener) {
    ...
    public void start() {
        synchronized (objLock) {
            if (client != null && !client.isStarted()) {
                client.start();
                currentLocationStatus = LocationService.POSITIONING;
            }
        }
    }
